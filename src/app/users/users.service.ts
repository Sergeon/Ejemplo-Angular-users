/**
    Crear una aplicación de Angular que muestre un listado con estos usuarios. 
    Debe haber un componente para la lista de los usuarios, y otro componente
    para las tarjetas o detalles de usuario, que debe contener lo siguiente:
    -- El nombre del usuario
    -- Un link a su página de github (html_url)
    -- La imagen del usuario
    El aspecto del componente debe cambiar si el usuario es un administrador.
*/
